...
| “农历六月初四11:00提醒我” | `lunarOnce` |
| “每年农历三月二十二09:58提醒我” | `lunarYearly` |

一次性农历提醒会自动选择下一次未来发生的农历日期。农历年重复不能直接用普通 cron 表达，因为每年对应的公历日期不同。插件使用 [`lunar-javascript`](https://github.com/6tail/lunar-javascript) 把未来若干年的农历日期换算成具体公历日期，再预创建一次性提醒。
